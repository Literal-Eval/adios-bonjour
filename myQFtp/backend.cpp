...
void Backend::setWindowPos(int x, int y, int width, int height, QString type)
{
    if (type == "PC")
    {
        clientPos.clear();
        clientPos.append(x);
        clientPos.append(y);
        clientPos.append(width);
        clientPos.append(height);
    }
    ...
    else
    {
        ...
        serverPos.append(x);
        serverPos.append(y);
        serverPos.append(width);
        serverPos.append(height);
    }
}

QList<int> Backend::getClientPos()
{
    return clientPos;
}

QList<int> Backend::getServerPos()
{
    return serverPos;
}
